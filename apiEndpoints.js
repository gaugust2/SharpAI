const nflEndpoints = {
    ...
    games: 'https://api.sportsdata.io/v3/nfl/scores/json/SchedulesBasic/2024',
...
const nbaEndpoints = {
    ...
    games: 'https://api.sportsdata.io/v3/nba/scores/json/SchedulesBasic/2025',
    bakerProjections: (gameID) =>
...
const mlbEndpoints = {
    ...
    games: 'https://api.sportsdata.io/v3/mlb/scores/json/SchedulesBasic/2025',
    bakerProjections: (gameID) =>
